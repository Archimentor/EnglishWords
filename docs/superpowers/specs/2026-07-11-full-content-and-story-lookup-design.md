...
> **상태: 이전 설계.** 별도 어휘 확장 장면은 사용자 피드백으로 폐기되었습니다. 현행 구현은 레벨별 장편 소설 본문 안에서 전체 목표 단어와 구동사를 사용하고, 본문에서 직접 뜻을 여는 방식입니다. 최신 요구사항은 `docs/brainstorms/2026-08-20-narrative-story-quality-requirements.md`를 따릅니다.
